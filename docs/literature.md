Apart from [Data Mining: Practical Machine Learning Tools and Techniques](https://cs.waikato.ac.nz/ml/weka/book.html), there are several other books with material on Weka:
